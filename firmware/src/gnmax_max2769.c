...
#define SPI_CS     0x04 //CS: set low to write data, high after finishing
#define SPI_SCK    0x08 //SDK serial clock
#define SHDN       0x01 //SHDN pin, device active when high
#define SPI_SDATA  0x80 //SDATA serial data
