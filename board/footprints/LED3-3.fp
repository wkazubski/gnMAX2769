...
# of annular ring.
	Pin(-100 0 65 43 "1" 0x101)
	Pin(0 0 65 43 "2" 0x01)
	Pin(100 0 65 43 "3" 0x01)
   ElementArc(0 0 59 59    30  120 10)
	ElementArc(0 0 59 59   210  120 10)
   ElementArc(0 0 79 79    30  120 10)
	ElementArc(0 0 79 79   210  120 10)
	Mark(0 0)
)
